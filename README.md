 CS50x - Week 0: Bug Simulator Game
...
Instead of just writing basic code, I wanted to build something fun and visual. I created a space-themed catching game where the player controls a hungry frog on a mission to catch flying insects and treats under a beautiful starry night sky.

 Core Programming Logic Implemented:

User Input & Personalization: Used the answer block to dynamically prompt and store the player's name (shoutout to Ammar!).

Real-time Scoring System: Implemented a global score variable that updates instantly whenever a collision/catch is detected.
